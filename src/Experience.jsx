...
const ExperienceCard = () => {
  ...
  useEffect(()=>{
    const fetchCurrentDetails=async()=>{
      try{
        ...
        const response=await axios.get(`http://192.168.0.119:8080/hrmsapplication/currentexperience/HRMS1`)
  ...
  const validateForm = () => {
    ...
    }else if (formData.reportingManagerId.length < 4 || formData.employeeId.length > 40) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.patch(`http://192.168.0.119:8080/hrmsapplication/currentexperience/updateCurrentEmployement`, payload);
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      if (isEditMode) {
        ...
        try {
          const response = await axios.post(`http://192.168.0.119:8080/hrmsapplication/currentexperience/createCurrentEmployement?employeeId=HRMS1`, payload);
             ...
             <div className="col-span-1 ">
              ...
              <div className="col-span-1 ">
                ...
                <input
                  ...
                  className="w-full p-1 border border-gray-300 rounded-lg"
                />
                {formErrors.reportingManagerId && <p className="text-red-600 text-sm mt-1">{formErrors.reportingManagerId}</p>}
                </div>
                <div className="col-span-1 ">
